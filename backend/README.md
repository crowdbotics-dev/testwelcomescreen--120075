...
## Project Structure
    ...
    ├── testwelcomescreen__120075  # Django project configurations
...
1. Clone this repo and `cd testwelcomescreen__120075`
...
2. Clone this repo and `cd testwelcomescreen__120075`
